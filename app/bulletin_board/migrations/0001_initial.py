    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_to_call",
                    models.CharField(max_length=3000, verbose_name="time to call"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photos",
                    models.ImageField(upload_to="photos/", verbose_name="photos"),
                ),
                (
                    "status",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="bulletin_board.regiondirectory",
                        verbose_name="region",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "moderation_date",
                    models.DateTimeField(auto_now=True, verbose_name="moderation date"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="created at"),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="bulletin_board.citiesdirectory",
                verbose_name="city",
            ),
        ),
        migrations.AddField(
